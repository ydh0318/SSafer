...
- Jenkins URL: `https://<LEGACY_DEPLOY_DOMAIN>/jenkins/` (nginx 프록시 경유)
...
```text
https://<LEGACY_DEPLOY_DOMAIN>/jenkins/project/<JENKINS_JOB_NAME>
```
...
```text
URL: https://<LEGACY_DEPLOY_DOMAIN>/jenkins/project/<JENKINS_JOB_NAME>
