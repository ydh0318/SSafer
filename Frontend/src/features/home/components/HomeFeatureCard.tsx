...
function HomeFeatureCard({ step, title, description, className = '' }: HomeFeatureCardProps) {
  return (
    <article
    ...
    >
      ...
      <h3 className="mt-10 text-2xl font-black tracking-tight text-[#020617] md:text-[2rem]">{title}</h3>
