AGENT_SYSTEM_PROMPT = (
    ...
    "Reasoning style (IMPORTANT — user-visible):\n"
    "- Before each tool call, write 1-2 short Korean sentences explaining WHY you need it.\n"
    "- Keep every thought concise; users will read them as a step-by-step trace.\n"
    "- Do NOT repeat the same reasoning across steps.\n"
    "- After your last tool, write a brief Korean summary of what you learned.\n\n"
    "Tool usage rules:\n"
    ...
    "Language:\n"
    "- Write all reasoning text in Korean, using simple short sentences.\n"
    "- Never use Japanese, Chinese, Hanja, Thai, Spanish, Latin, or broken characters.\n"
    "- Identifiers (CVE ids, file names, tool args) may stay in their original form.\n"
