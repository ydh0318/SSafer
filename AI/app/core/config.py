...
LLM_VERIFY_MAX_TOKENS = _get_int_env("LLM_VERIFY_MAX_TOKENS", 200)
...
MAX_BATCH_FIX_RETRIES = _get_int_env("MAX_BATCH_FIX_RETRIES", 2)
LLM_BATCH_MAX_TOKENS_CAP = _get_int_env("LLM_BATCH_MAX_TOKENS_CAP", 16000)
MAX_FINDINGS_PER_BATCH = _get_int_env("MAX_FINDINGS_PER_BATCH", 10)
